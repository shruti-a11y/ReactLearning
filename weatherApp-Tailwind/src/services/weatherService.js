...
const API_KEY = 'b08e7c31dc7e5c4d82a39a03e3544e38'
...
// to create url from code value we get from server
...
//get data from server and place them in variable 
...
const getFormattedWeatherData = async (searchParams) => {
    const formatedCurrentWeather = await getWeatherData('weather', searchParams).then(formatCurrent);
